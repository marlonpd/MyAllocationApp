...
const EditBudgetModal = (props) => {
  useEffect(() => {
    setselectedBudgetItem(props.selectedBudgetItem)
  }, [props.selectedBudgetItem])

  const updateBudgetItemHandler = () => {
    props.onUpdateBudgetItem(selectedBudgetItem)
  }
    ...
    <Modal visible={props.visible} animationType='slide'>
      <View style={styles.inputContainer}>
        ...
        <TextInput
          ...
          value={String(selectedBudgetItem.amount)}
        />
        <View style={styles.buttonContainer}>
          ...
          <View style={styles.button}>
            <Button title='UPDATE' onPress={updateBudgetItemHandler} />
          </View>
        </View>
      </View>
    </Modal>
